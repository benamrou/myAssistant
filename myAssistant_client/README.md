# myAssistant rewritten in Angular6 and Bootstrap 4

myAssistant Dashboard Admin App built using Angular 6 and Bootstrap 4
...
`myAssistant` provides the following features:
...
```bash
$ git clone https://github.com/benamrou/SmyAssistant
