...
@Component({
    ...
    providers: [MessageService, ChartModule, ConfirmationService, QueryService],
...
export class DesignComponent implements OnInit, OnDestroy {
    ...
    constructor(public _messageService: MessageService, private _queryService: QueryService, 
        ...
        this.columnTemplates = [
          ...
          this.topMenuTab = [
              ...
              {label: 'Scope', icon: 'pi pi-fw pi-calendar'},
              {label: 'Agenda', icon: 'pi pi-fw pi-calendar'},
              {label: 'Session', icon: 'pi pi-fw pi-pencil'},
              {label: 'Process', icon: 'pi pi-fw pi-pencil'},
              {label: 'Deliverables', icon: 'pi pi-fw pi-file'},
              {label: 'Settings', icon: 'pi pi-fw pi-cog'}
          ];
          this.activeMenu = this.topMenuTab [0];
    }
    ...
    getActiveMenu(item) {
        console.log('Active Menu avant: ', item, this.activeMenu);
        this.activeMenu = item;
        console.log('Active Menu apres: ', item, this.activeMenu);
