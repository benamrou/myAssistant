...
import { TreeDragDropService, MessageService, ConfirmationService } from 'primeng/api';
import {  ProcessService, ParamService, ImportService, ExportService } from '../../../../shared/services';
...
@Component({
    ...
    providers: [ ProcessService, ParamService, MessageService, TreeDragDropService, ImportService, ExportService, ConfirmationService],
