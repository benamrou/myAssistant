...
@Component({
	  moduleId: module.id,
    selector: 'mdm-attribute',
    templateUrl: './mdm.attribute.component.html',
    providers: [ WidgetService, ProcessService, MessageService, TreeDragDropService],
    styleUrls: ['./mdm.attribute.component.scss', '../../../app.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class MdmAttributeComponent {
