...
export class HeaderDesignerComponent implements OnInit {
	...
	@Output() languageSwitched = new EventEmitter();
	  ...
	  lbl_titleApplication = {id: 'DESIGN000000000001', desc: ''};
	  lbl_usersSetting 	 = {id: 'DESIGN000000000004', desc: ''};
	  lbl_logout 		 	 = {id: 'DESIGN000000000005', desc: ''};
