...
import { SharedModule, Header, PrimeTemplate } from '../api/shared';
...
export class Accordion implements BlockableUI, AfterContentInit, OnDestroy {
    ...
    @Input() expandIcon: string = 'fa fa-fw pi-chevron-right';

    @Input() collapseIcon: string = 'fa fa-fw pi-chevron-down';
