...
@NgModule({
    ...
    exports: [Header,Footer,PrimeTemplate, FooterColumnGroup, HeaderColumnGroup, Column, Row],
    declarations: [Header,Footer,PrimeTemplate, FooterColumnGroup, HeaderColumnGroup, Column, Row]
})
