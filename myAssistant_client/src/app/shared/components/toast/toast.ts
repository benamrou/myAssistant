    ...
    template: `
        <div #container class="ui-toast-message ui-shadow" [@messageState]="{value: 'visible', params: {showTransitionParams: showTransitionOptions, hideTransitionParams: hideTransitionOptions}}"
            ...
            <div class="ui-toast-message-content">
                <a tabindex="0" class="ui-toast-close-icon fa fa-times" (click)="onCloseIconClick($event)" (keydown.enter)="onCloseIconClick($event)" *ngIf="message.closable !== false"></a>
                <ng-container *ngIf="!template">
                    <span class="ui-toast-icon fa"
                        [ngClass]="{'fa-info-circle': message.severity == 'info', 'fa-exclamation-triangle': message.severity == 'warn',
                            'fa-times': message.severity == 'error', 'fa-check' :message.severity == 'success'}"></span>
