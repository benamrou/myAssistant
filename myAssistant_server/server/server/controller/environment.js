/**
* This is the description for Environment API class. The initlaized request for CORS (different URL reuqest)
...
*
* API Library: /controller/Environment
*
...
* @return {Boolean} Returns the user environment information
*
* sub-module calls LIBQUERY entry CLI0000003
*/
