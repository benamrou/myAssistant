/**
* This is the description for Process API class. The initlaized request for CORS (different URL reuqest)
...
*
* API Library: /controller/itemretail
*
...
* Http Method: GET
* URL        : /api/itemretail/?PARAM=...
*
*
* @method get
* @param {Object} request HTTP request. The request must contain :
*       - USER in the header (for log)
*       - BATCH DATE in the request
*       - BATCH NAME in the request
*       - BATCH ARGS in the request 
